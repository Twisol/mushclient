...
int __stdcall BrowseCallbackProc(HWND hwnd,
                                 UINT uMsg,
                                 LPARAM lParam,
                                 LPARAM lpData
                                 );
...
CGlobalPrefsP1::CGlobalPrefsP1()
  : CPropertyPage(CGlobalPrefsP1::IDD)
{
...
void CGlobalPrefsP1::OnNewStartupWorld() 
{
  ...
  if (nResult == IDOK)
    ...
    strWorldCount.Format ("%i world%s", PLURAL(pList->GetCount()));
...
void CGlobalPrefsP1::OnUpdateNeedCurrentWorld(CCmdUI* pCmdUI)
{
  ...
  pCmdUI->Enable (m_pCurrentDoc != NULL && !m_pCurrentDoc->GetPathName ().IsEmpty ());
}
...
CGlobalPrefsP2::CGlobalPrefsP2()
  : CPropertyPage(CGlobalPrefsP2::IDD)
{
...
CGlobalPrefsP3::CGlobalPrefsP3()
  : CPropertyPage(CGlobalPrefsP3::IDD)
{
...
CGlobalPrefsP4::CGlobalPrefsP4() 
  : CPropertyPage(CGlobalPrefsP4::IDD)
{
...
void CGlobalPrefsP4::OnFont() 
{
  ...
  CFontDialog dlg (&lf, CF_BOTH, NULL, GetOwner ());
...
CGlobalPrefsP5::CGlobalPrefsP5()
  : CPropertyPage(CGlobalPrefsP5::IDD)
{
...
CGlobalPrefsP6::CGlobalPrefsP6()
  : CPropertyPage(CGlobalPrefsP6::IDD)
{
                                 ...
                                 LPARAM lParam, LPARAM lpData)
{
  ...
  if (uMsg == BFFM_INITIALIZED)
    ...
    else if (strStartingDirectory.Left (2) == ".\\")
      {
      strStartingDirectory = working_dir;
    ...
    if (strStartingDirectory.GetLength () > 2 &&
        (strStartingDirectory [1] == ':' || strStartingDirectory.Left (2) == "\\\\"))
...
static void RemoveTrailingBackslash (CString& str)
{
...
CGlobalPrefsP7::CGlobalPrefsP7()
  : CPropertyPage(CGlobalPrefsP7::IDD)
{
...
CGlobalPrefsP9::CGlobalPrefsP9()
  : CPropertyPage(CGlobalPrefsP9::IDD)
{
...
void CGlobalPrefsP9::OnSelectOutputFont() 
{
  ...
  lf.lfItalic = FALSE;
  lf.lfCharSet = (BYTE) m_iDefaultOutputFontCharset;

  CFontDialog dlg (&lf, CF_SCREENFONTS, NULL, GetOwner ());
...
void CGlobalPrefsP9::OnSelectInputFont() 
{
  ...
  lf.lfCharSet = (BYTE) m_iDefaultInputFontCharset;
  ...
  if (m_iDefaultInputFontWeight == FW_BOLD) strStyle += " bold";
  if (m_iDefaultInputFontItalic) strStyle += " italic";
...
CGlobalPrefsP10::CGlobalPrefsP10()
  : CPropertyPage(CGlobalPrefsP10::IDD)
{
...
CGlobalPrefsP11::CGlobalPrefsP11()
  : CPropertyPage(CGlobalPrefsP11::IDD)
{
...
CGlobalPrefsP12::CGlobalPrefsP12()
  : CPropertyPage(CGlobalPrefsP12::IDD)
{
...
void CGlobalPrefsP12::OnNewPlugin() 
{
  ...
  if (nResult == IDOK)
    ...
    SetDlgItemText(IDC_PLUGIN_COUNT, strPluginCount);
      ...
      // Too many files - buffer not large enough
...
void DoGlobalPrefs (CMUSHclientDoc * pCurrentDoc)
{
  ...
  if (pApp->m_iDefaultInputFontWeight == FW_BOLD) strStyle += " bold";
  if (pApp->m_iDefaultInputFontItalic) strStyle += " italic";
  ...
  if (pApp->m_nTimerInterval != propSheet.m_Page6.m_nTimerInterval)
    ...
    if (propSheet.m_Page6.m_nTimerInterval > 0)
      nInterval = propSheet.m_Page6.m_nTimerInterval * 1000;
    else
      nInterval = MIN_TIMER_INTERVAL; // 1/10 of a second ;)

    Frame.m_timer = Frame.SetTimer(ACTIVITY_TIMER_ID, nInterval, NULL );
