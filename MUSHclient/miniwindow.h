...
enum
{
  MINIWINDOW_DRAW_UNDERNEATH   = 0x01, // draw underneath scrolling text
  MINIWINDOW_ABSOLUTE_LOCATION = 0x02, // use m_iLeft, m_iTop to position 
  MINIWINDOW_TRANSPARENT       = 0x04, // draw transparently, using m_iBackgroundColour 
  MINIWINDOW_IGNORE_MOUSE      = 0x08, // ignore mouse-down, mouse-over etc. 
};
